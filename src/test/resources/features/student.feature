Feature: Testing different request on the student application
  ...
  Scenario Outline: Create a new student & verify if the student is added
    ...
    Examples:
      | firstName | lastName | email            | programme        | courses |courses1 |
      | Prime1    | Testing  | prime1@gmail.com | Computer Science | JAVA    |JAVA1   |
      | Prime2    | Testing  | prime2@gmail.com | Api Testing      | Python  |Python1  |